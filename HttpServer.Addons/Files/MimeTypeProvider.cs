...
namespace HttpServer.Addons.Files
{
    ...
    public class MimeTypeProvider
    {
        ...
        internal MimeTypeProvider()
        {
            ...
            _items.Add("webp", "image/webp");

            _items.Add("js", "application/javascript");
            _items.Add("json", "application/json");
            ...
            _items.Add("xap", "application/x-silverlight-app");
            _items.Add("xaml", "application/xaml+xml ");

            // HTML5 audio/video
            _items.Add("webm", "video/webm");
            _items.Add("mp4", "video/mp4");
            _items.Add("ogg", "video/ogg");
            _items.Add("ogv", "video/ogg");
            _items.Add("oga", "audio/ogg");
            _items.Add("mp3", "audio/mp3");

            // For PHP module
            _items.Add("php", "application/x-httpd-cgi");
        }
