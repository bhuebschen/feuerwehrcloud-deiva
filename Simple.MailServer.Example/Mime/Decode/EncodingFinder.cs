...
{
	/// <summary>
	/// Utility class used by FeuerwehrCloud for mapping from a characterSet to an <see cref="Encoding"/>.<br/>
	/// <br/>
	...
	/// </list>
	/// </summary>
	internal static class EncodingFinder
	{
		/// <summary>
		...
		internal delegate Encoding FallbackDecoderDelegate(string characterSet);
